...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [dat_micro, dat_macro] = readLFP(cfg,MuseStruct, force)
%
% Reads data from macro and micro electrodes, epoched according to markers
% extracted from Muse. Will also mark overlap with hypnogram markers
...
%
% Note: that ames of markers that contain a space (' ') or minus ('-') are
