...
%% load data
name_file = '\\lexport\iss01.charpier\analyses\wod\Pierre\images';
for iwave= ["WoD"]
    for itime= ["peak_time" "min_slope_time" "start_time"]
        ...
        fname_raw=fullfile(name_file,'delays900',sprintf('%s_%s_raw',iwave,itime));
        
        if ~isfolder(fullfile(name_file,'delays900'))
            mkdir(fullfile(name_file,'delays900'));
        end
        %save figure
        ...
        fname_medraw=fullfile(name_file,'delays900',sprintf('%s_%s_median_raw',iwave,itime));
        ...
        fname_meanraw=fullfile(name_file,'delays900',sprintf('%s_%s_mean_raw',iwave,itime));
        ...
        fname_norm=fullfile(name_file,'delays900',sprintf('%s_%s_norm',iwave,itime));
...
%         
        ...
        fname_mednorm=fullfile(name_file,'delays900',sprintf('%s_%s_median_norm',iwave,itime));
        ...
        fname_meannorm=fullfile(name_file,'delays900',sprintf('%s_%s_mean_norm',iwave,itime));
